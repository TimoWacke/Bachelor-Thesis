...
After creating an account online an API Key can be obtained for free and with the python module 'cdsapi' data can be downloaded then easily in \code{.grib} format. 
...
As pointed out in \autoref{sec: cds_api} the data is downloaded in \code{.grib} format. Using the program 'cdo' the data can be quickly converted to \code{.nc} format.
